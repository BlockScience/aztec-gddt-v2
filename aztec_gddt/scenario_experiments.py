...
# Scenario Specs
# The below experiment_scenarios define the parameters that are swept over as well as simulation parameters such as number of timesteps, samples, etc.
# The swept parameter are defined in the default_params.py file.
...
experiment_feemech_oracle_sensitivity = ExperimentParamSpec(
    ...
    params_swept_env={
        ...
        'PROVING_COST_MODIFICATION_E': [-0.001, 0.0, 0.001],  
        'FEE_JUICE_PRICE_MODIFICATION_E': [-0.001, 0.0, 0.001], 
    },
    N_timesteps=3_000,
    N_samples=100,
    N_config_sample=-1,
